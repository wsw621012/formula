...
class AutoDrive(object):
    ...
    def on_dashboard(self, src_img, last_steering_angle, speed, throttle, info):
        ...
        current_angle = ImageProcessor.find_steering_angle_by_color(track_img, last_steering_angle, debug = False)
        ...
        print("steering_angle = %s" % current_angle)
        throttle       = self._throttle_pid.update(speed)
        print("-deg%0.3f" % (ImageProcessor.rad2deg(steering_angle)))
